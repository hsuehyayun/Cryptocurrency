...
const ASSETS = {
    "USDC": { "mint": "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", "decimals": 6, "allocation": new Decimal('0.30') },
    "SOL": { "mint": "So11111111111111111111111111111111111111112", "decimals": 9, "allocation": new Decimal('0.30') },
    "JLP": {"mint": "27G8MtK7VtTcCHkpASjSDdkWWYfoqT6ggEuKidVJidD4", "decimals": 6, "allocation": new Decimal('0.40') },
};
...
const RPC_ENDPOINT = "https://mainnet.helius-rpc.com/?api-key=7ef8eb8e-9c10-49ef-b430-8f38194e3de2";
...
async function getJupiterSwapInstructions(fromAccountPublicKey, inputMint, outputMint, amountLamports, slippageBps = 100) {
    ...
    try {
        ...
        const swapInstructionsURL = 'https://lite-api.jup.ag/swap/v1/swap-instructions';
        const body = {
